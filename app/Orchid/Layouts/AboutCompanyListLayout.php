...
class AboutCompanyListLayout extends Table
{
    /**
     * Data source.
     *
    ...
    {
        return [
            TD::make('id','ID')->sort()->render(function(AboutCompany $item) {
                return Link::make($item->id)
                    ->route('platform.about_company.edit', $item);
            }),
            TD::make('year', 'Год')->sort()->filter(Input::make()),
