...
@section('content')
    ...
    <section class="commerce section">
        <div class="container">
            ...
            <div class="commerce-info">
                <div class="commerce-info__slider-wrap">
                    <div class="commerce-info__slider">
                        ...
                        <!-- Add Pagination -->
                        <div class="commerce-info__slider-pagination"></div>
                        <div class="commerce-info__slider-prev"></div>
                        <div class="commerce-info__slider-next"></div>
                    </div>
                </div>
                <div class="apartment-info__content">
                    <div class="apartment-info__header">
                        <h4 class="apartment-info__title">{{$item->title}}</h4>
                        <p>№ {{$item->number}}</p>
                    </div>
                    <div class="apartment-info__columns">
                        ...
                        <div class="apartment-info__column">
                            @if($item->type)
                                <p>{{implode('/', json_decode($item->type, true))}}</p>
                            @endif
                            <p>{{$item->jk->title}}</p>
                            <p>{{$item->address}}</p>
                            <p>{{$item->square}}</p>
                    ...
                    <div class="apartment-info__price-wrap">
                        <p>{{Price::getBaseFormat($item->base_price)}} ₽/мес</p>
                        <!--            <span>119 000 за м²</span>-->
                    </div>
                    <div class="apartment-info__btns-container">
                        <button class="btn btn-green" data-modal="modal-buyback">Забронировать</button>
                        <div class="apartment-info__icons">
                            <div class="apartment-info__icons-item">
                                <svg class="card-apartment__favorite" width="63" height="63" viewBox="0 0 63 63" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          ...
                                          stroke="#8C8C8C" stroke-width="3.0891" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                            <div class="apartment-info__icons-item">
                                <div class="share-drodown__wr">
                                    <div class="share-drodown">
                                        <div class="share-drodown__btn"><svg width="63" height="63" viewBox="0 0 63 63" fill="none"
                                                                             xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <ul class="share-drodown__menu">
                                            <li><a class='share-current-link-tg' href="" target="_blank"><img src="/assets/img/icons/telegram-mini.svg"
                                                                                                              alt="">Отправить в Telegram</a></li>
                                            <li><a class='share-current-link-wht' href="" target="_blank"><img src="/assets/img/icons/whatsapp-mini.svg"
                                                                                                               alt="">Отправить в Whatsapp</a></li>
                                            <li>
                                                <a class="share-copy-btn"><img src="/assets/img/icons/copy-link-mini.svg" alt=""><span>Скопировать ссылку</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    @if(!$similar->isEmpty())
        <section class="apartment-similar section">
            <div class="container">
                <h3 class="title">ПОХОЖИЕ ОБЪЕКТЫ</h3>
                                    ...
                                    <div class="card-commerce__desc">
                                        <div class="card-commerce__desc-row">
                                            <div class="card-commerce__desc-col">
                                                <div class="card-commerce__title">{{$similarItem->title}}</div>
                                                <div class="card-commerce__sub-title">{{$similarItem->address}}</div>
                                            </div>
                                        ...
                                        <div class="card-commerce__row">
                                            <div class="card-commerce__info-container">
                                                <div class="card-commerce__info-item">
                                                    ...
                                                    <div class="card-commerce__info-value">{{$similarItem->square}}</div>
                                                </div>
                                                <div class="card-commerce__info-item">
                                                    <div class="card-commerce__info-title">Сдача</div>
                                                    <div class="card-commerce__info-value">{{$similarItem->lease}}</div>
                                                </div>
                                                <div class="card-commerce__info-item">
                                                    <div class="card-commerce__info-title">Цена от</div>
                                                    <div class="card-commerce__info-value">{{Price::getBaseFormat($similarItem->base_price)}} р/мес</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    @include('partials.forms.commerce')
@endsection