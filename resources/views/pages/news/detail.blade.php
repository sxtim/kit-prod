        ...
        <section class="section">
            <div class="news-detail__inner _inner">
                <div class="news-detail__content">
                    ...
                    <a class="btn btn-green news-detail__btn" href="{{route('news-list')}}">Вернуться к новостям</a>
                </div>
                <div class="news-detail__inner-item">
                    <img class="news-detail__img" src="/assets/img/apartments/sputnik/sp-g-07.jpg" alt="img">
                </div>
            </div>
        </section>
    </div>
